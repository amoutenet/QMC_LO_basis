...
struct measure_density_mix {
 ...
 measure_density_mix(configuration* config_, vector<double>* d_, vector<double>* e_, vector<double>* p_, vector<double>* s_, int max_order_, double tm_, double lambda_, bool is_alpha_sym)
