...
struct change_order_haar_scattering {
 ...
 change_order_haar_scattering(configuration *config_, triqs::mc_tools::random_generator* RNG_, int order_max_, int order_min_, double t_max_, double lambda_, double cauchy_t, double cauchy_a, dcomplex diag_, std::vector<triqs::arrays::matrix<int>> p_):
