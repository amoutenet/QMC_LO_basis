...
struct change_order_cluster_groupings {
 ...
 change_order_cluster_groupings(configuration *config_, triqs::mc_tools::random_generator* RNG_, int order_max_, int order_min_, double t_max_, double lambda_, double cauchy_t, double cauchy_a, dcomplex diag_):
